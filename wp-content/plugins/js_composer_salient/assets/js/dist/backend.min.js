...
! function(l) {
  _.isUndefined(window.vc) && (window.vc = {}), l.ajaxSetup({
      ...
      return ["css", "js_header", "js_footer"].forEach(function(e) {
          var e = "$custom_" + e;
          // nectar addition || to && - core WPBakery bug in 7.7
  ...
  function(s) {
      vc.SeoAnalysisView = Backbone.View.extend({
          ...
          getContentWrapper: function() {
              return "admin_frontend_editor" === window.vc_mode ? vc.$frame.contents().find(".wpb-content-wrapper") : s("#wpbakery_content")
          }
...
! function(r) {
  vc.saved_custom_css = !1, vc.createPreLoader = function() {
      ...
      updateRowsSorting: function(a, i) {
          _.defer(function(e) {
              var t = i.item.parent(),
                  ...
                  n = i.item.parent().closest("[data-element_type]").data("element_type") || "";
              vc.check_relevance(n, o) && n != o ? (n = c.get("parent_id"), t.find(e.rowSortableSelector).each(function() {
                  var e = r(this).index();
                  ...
                  parent_id: s
              }), n && e.views[n].checkIsEmpty(), s && e.views[s].checkIsEmpty()) : r(a.target).sortable("cancel")
          }, this)
      },
          ...
          if (vc_user_access().partAccess("dragndrop")) return r(".wpb_main_sortable").sortable({
              ...
              stop: function(e, t) {
                  ...
                  var s = t.item.data("element_type"),
                      ...
                      o = !!_.isUndefined(vc.map[c].allowed_container_element) || vc.map[c].allowed_container_element;
                  vc.check_relevance(c, s) && c != s || r(this).sortable("cancel"), _.isObject(vc.map[s]) && (_.isBoolean(vc.map[s].is_container) && !0 === vc.map[s].is_container || !_.isEmpty(vc.map[s].as_parent)) && !0 !== o && o !== t.item.data("element_type").replace(/_inner$/, "") && r(this).sortable("cancel"), r(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
              },
      ...
      navOnScroll: function() {
          this.$nav = r("#vc_navbar"), this.setNavTop(), this.processScroll(), r(window).off("scroll.composer").on("scroll.composer", this.processScroll)
      },
      processScroll: function(e) {
          !0 === this.disableFixedNav ? this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || this.navTop < 0) && this.setNavTop(), this.scrollTop = r(window).scrollTop() + 80, 0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, this.$nav.addClass("vc_subnav-fixed")) : this.scrollTop <= this.navTop && this.isFixed && (this.isFixed = 0, this.$nav.removeClass("vc_subnav-fixed")))
      },
      ...
      changePostCustomLayout: function(e) {
          var t, s;
          e && e.preventDefault && (e.preventDefault(), e = r(e.currentTarget).attr("data-post-custom-layout"), t = r("#wpb_wpbakery"), (s = r("#vc_ui-panel-post-settings .vc_post-custom-layout[data-post-custom-layout=" + e + "]")).addClass("vc-active-post-custom-layout"), s.siblings().removeClass("vc-active-post-custom-layout"), r("input[name=vc_post_custom_layout]").val(e), t.find(".vc_navbar").addClass("vc_post-custom-layout-selected"), t.find(".metabox-composer-content").addClass("vc_post-custom-layout-selected"))
      },
